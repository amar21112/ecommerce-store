...
class AbstractModel
{
  const DATABASE_TYPE_BOOL = \PDO::PARAM_BOOL;
  const DATABASE_TYPE_STR = \PDO::PARAM_STR;
  const DATABASE_TYPE_INT = \PDO::PARAM_INT;
  const DATABASE_TYPE_DECIMAL = 4;
  const DATABASE_TYPE_DATE = 5;
